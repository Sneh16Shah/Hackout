...
<body>
        ...
        <div class="container-fluid-hero">
            <div class="row">
                <div class="col-lg-6 hero-intro">
                    <h1><span>Welcome to our CollegeBuddy</span></h1>
                    <p></p>
                    <a href="explore.html"><button class="btn btn-lg cta">Explore</button></a>
                </div>
                <div class="col-lg-6 hero-image pt-5 pl-5">
                    <img class="image-fluid 	.d-none .d-lg-block .d-xl-none image-width" src="Hero Image.gif" alt="Hero Image">
                </div>
            </div>
        </div>
    ...
    <section id="description-section">
        <div id="go-here" class="container-fluid">
            ...
            <p>This platform is designed to connect women all over the world where they can get all information related
                to the tech and
                can share their ideas. They can get resources as per their need and can connect with other women to work
                upon their
                ideas. It can also be used by women to sell their homemade products which will help them in their
                economic growth.</p>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <p><i class="fas fa-calendar-check fa-2x"></i></p>
                            <h5>Resources</h5>
                            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis a urna
                                enim. Integer in sapien lorem. In hac habitasse
                                platea dictumst.</p>
                            <a href="resources.html"><button class="btn btn-lg description-cta">Learn more</button></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis a urna
                                enim. Integer in sapien lorem. In hac habitasse
                                platea dictumst.</p>
                            <a href="#"><button class="btn btn-lg description-cta">Learn more</button></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4">
    ...
    <footer>
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <a href="https://github.com/KushalBhanot/Techify">
