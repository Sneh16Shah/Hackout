...
<?php
    ...
    {   
        ...
        // echo "</u>";
        echo "<br>";
        echo "Job desc - ".$row['job_desc']."<br> Joining date - ".$row['join_date']."<br> Tenure - ".$row['tenure']." months<br> Location - ".$row['location']." <br> Salary - ".$row['salary']."Rs <br>Name - ".$row['name']." <br>Email - ".$row['email']."<br> Mobile - ".$row['mobile'];
